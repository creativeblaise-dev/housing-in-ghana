      ...
      <div className="relative flex pt-5 w-full overflow-hidden bg-[url('/images/prydumano-design-vIbxvHj9m9g-unsplash.jpg')] bg-center [background-size:cover] antialiased md:items-center md:justify-center px-10 md:px-20 pb-10 md:py-15 ">
        ...
        <div className="relative z-10  mx-auto w-full max-w-7xl  ">
                  ...
                  (
                    ...
                    return (
                      <Link
                        ...
                        href={`/articles/${slug}`}
                      >
                        <div className="shrink-0 relative rounded-xl overflow-hidden w-full h-67.5 before:absolute before:inset-x-0 before:z-1 before:size-full before:bg-linear-to-t before:from-gray-900/70 border-2 border-[#dfdfdf96]">
                          <Image
          ...
          <div className="flex justify-end">
            <Link href="/articles">
              <Button className="bg-zinc-200 text-stone-800 cursor-pointer hover:bg-zinc-300">
                Read Our Articles
              </Button>
            </Link>
          </div>
