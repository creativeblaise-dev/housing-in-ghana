  ...
  return (
    <section className="flex md:gap-15 flex-col md:flex-row px-10 md:px-20 pb-10 md:py-5  bg-[#ffffff]">
      ...
      <div className=" md:flex-3 ">
        ...
        <p className="text-md">
          Stay informed with Housing In Ghana Magazine your guide to the people,
          projects, and policies shaping Ghana’s real estate scene. Each edition
          features expert opinions, success stories, investment tips, legal
          updates, and the latest in housing trends. Whether you're a first-time
          buyer, developer, or industry professional, there's something for you
          inside every page.
        </p>
