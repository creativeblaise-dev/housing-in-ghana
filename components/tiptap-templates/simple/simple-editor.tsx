...
export const SimpleEditor = React.forwardRef<SimpleEditorRef, EditorProps>(
  ({ content, onChange }, ref) => {
    ...
    const editor = useEditor({
      ...
      onUpdate: ({ editor }) => {
        // Call onChange when editor content changes
        if (onChange) {
      ...
      <div className="">
        <EditorContext.Provider value={{ editor }}>
          ...
          <EditorContent
            editor={editor}
            role="presentation"
            className="bg-zinc-100 text-sm text-stone-900 h-100 overflow-y-auto p-4 md:p-6 lg:p-8 rounded-b-xl"
          />
