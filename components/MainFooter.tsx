    ...
    <>
      <footer className="bg-[#232525] lg:grid lg:grid-cols-5 dark:bg-gray-900 mt-0">
        ...
        <div className="px-4 py-12 sm:px-6 lg:col-span-3 lg:px-8">
          ...
          <div className="mt-12 border-t border-stone-600 pt-12 dark:border-gray-800">
            <div className="sm:flex sm:items-center sm:justify-between">
              <ul className="flex flex-wrap gap-4 text-xs">
                <li>
                  <a
                    href="#"
                    className="text-gray-300 transition hover:opacity-75 dark:text-gray-400"
                  >
                    Terms & Conditions
                  </a>
                </li>
              ...
              <p className="mt-8 text-xs text-gray-300 sm:mt-0 dark:text-gray-400">
                &copy; 2025. Housing In Ghana. All rights reserved.
              </p>
            </div>
          </div>
        </div>
